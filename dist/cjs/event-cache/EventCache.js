...
var EventCache = /** @class */ (function () {
    ...
    function EventCache(applicationDetails, config, eventBus) {
        ...
        this.addRecordToCache = function (type, eventData) {
            ...
            _this.eventBus.dispatch(EventBus_1.Topic.EVENT, __assign(__assign({}, partialEvent), { details: eventData, metadata: metaData }));
        ...
        this.sessionManager = new SessionManager_1.SessionManager(applicationDetails, config, this.recordSessionInitEvent, this.pageManager);
